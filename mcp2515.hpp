...
enum struct Instruction
{
  ...
  */
  READ_RX_BUFFER_TXB0SIDH = 0x90, // TXB0SIDH
  READ_RX_BUFFER_TXB0D0 = 0x92,   // TXB0D0
  READ_RX_BUFFER_TXB1SIDH = 0x94, // TXB1SIDH
  READ_RX_BUFFER_TXB1D0 = 0x96,   // TXB1D0
...
public:
  ...
  Result setTXB0ID(bool isExtended, long id);
  Result setTXB1ID(bool isExtended, long id);
  Result setTXB2ID(bool isExtended, long id);
  Result setId(unsigned char n, bool isExtended, long id);
  long readRXB0ID();
  long readRXB1ID();
  long readId(unsigned char n);
  ...
  unsigned char *readRXB0Data();
  unsigned char *readRXB1Data();
